...
public class MlmvItemInit {
    ...
    public static final BlockItem CRIMSON_LOOM_I = itemFromBlock(CRIMSON_LOOM, true);
    public static final BlockItem WARPED_LOOM_I = itemFromBlock(WARPED_LOOM, true);

    public static BlockItem itemFromBlock(MoreLoomVariantBlock moreLoomVariantBlock) {
        return itemFromBlock(moreLoomVariantBlock, false);
    }

    public static BlockItem itemFromBlock(MoreLoomVariantBlock moreLoomVariantBlock, boolean isNether) {
        return new BlockItem(moreLoomVariantBlock, setProperties(moreLoomVariantBlock, isNether));
    }

    public static Item.Properties setProperties(MoreLoomVariantBlock moreLoomVariantBlock, boolean isNether) {
